...
public class UiObject {
	...
	public UiObject typeText(String text){
	...
	public UiObject scrollTo(){
		if(!locator.contains("text")) throw new RuntimeException("Scroll to method can only be used with"
				+ " text attributes and current location : "+locator+" does not contain any text attributes!");
		if(isXpath()){
